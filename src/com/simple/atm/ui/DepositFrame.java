...
public class DepositFrame extends JFrame {
    ...
    public DepositFrame(String card, ClientService clientService) {
        this.card = card;
        ...
        add(new HeaderBar("存款", null), BorderLayout.NORTH);
    ...
    private void doDeposit() {
        try {
            ...
            CommonResult r = clientService.deposit(card, amt);
